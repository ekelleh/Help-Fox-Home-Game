  ...
  */
   ...
   */
                ...
                if (this.collider) {
                    if (this.collider instanceof AABB) {
                        ...
                        if (this.colliderType === "custom") {
                            ...
                            this.collider.extents.x =
                                this._internalWidth * abs(cos(t)) + this._internalHeight * abs(sin(t));

                            this.collider.extents.y =
                                this._internalWidth * abs(sin(t)) + this._internalHeight * abs(cos(t));
                        }
                    }
        ...
        this.mouseUpdate = function() {
            ...
            if (camera.active) mousePosition = createVector(camera.mouseX, camera.mouseY);
